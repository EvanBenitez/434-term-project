...
class Computer_Player:
    ...
    def hard(self, board):
            ...
            #computer to make a non winning or blocking move
                ...
                self.grid[0][0] = 'X'
            elif self.grid[0][0] == 'O' and self.grid[1][1] == 'B':
                self.grid[1][1] == 'X'
            elif self.grid[0][2] == 'O' and self.grid[1][1] == 'B':
                self.grid[1][1] == 'X'
            elif self.grid[2][0] == 'O' and self.grid[1][1] == 'B':
                self.grid[1][1] == 'X'
            elif self.grid[2][2] == 'O' and self.grid[1][1] == 'B':
                self.grid[1][1] == 'X'
...
class GUI:
    ...
    def __init__(self):
        ...
        self.main_menu = pygame.Rect(self.loc_menu[0], self.loc_menu[1], self.menu_option_hor, 300) # attributes of main menu
        ...
        # menu attributes
        self.objects["new"] = (pygame.Rect(self.loc_menu[0],self.loc_newgame[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["1of1"] = (pygame.Rect(self.loc_menu[0],self.loc_of1[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["2of3"] = (pygame.Rect(self.loc_menu[0],self.loc_of3[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["3of5"] = (pygame.Rect(self.loc_menu[0],self.loc_of5[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["4of7"] = (pygame.Rect(self.loc_menu[0],self.loc_of7[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["pvp"] = (pygame.Rect(self.loc_menu[0],self.loc_playervsplayer[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["pvpc"] = (pygame.Rect(self.loc_menu[0],self.loc_playervspc[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["easy"] = (pygame.Rect(self.loc_menu[0],self.loc_easy[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["hard"] = (pygame.Rect(self.loc_menu[0],self.loc_hard[1], self.menu_option_hor, self.menu_option_vert), 1)
        self.objects["quit"] = (pygame.Rect(self.loc_menu[0],self.loc_quit[1], self.menu_option_hor, self.menu_option_vert), 1)
    ...
    def draw_board(self, board):
        ...
        self.objects["1,1"] = (pygame.Rect(left_bound+box_size+thickness, top_bound+box_size+thickness, box_size, box_size), 2)
        self.objects["1,2"] = (pygame.Rect(left_bound+2*(box_size+thickness), top_bound+box_size+thickness, box_size, box_size), 2)
        
        self.objects["2,0"] = (pygame.Rect(left_bound, top_bound+2*(box_size+thickness), box_size, box_size), 2)
        self.objects["2,1"] = (pygame.Rect(left_bound+box_size+thickness, top_bound+2*(box_size+thickness), box_size, box_size), 2)
        self.objects["2,2"] = (pygame.Rect(left_bound+2*(box_size+thickness), top_bound+2*(box_size+thickness), box_size, box_size), 2)
    ...
    def click_item(self, mouse_position):
        ...
        for item in self.objects:
           if self.objects[item][0].collidepoint(mouse_position):
               if self.menu == True and self.objects[item][1] == 1:
                   print(item)
                   return item
               elif self.board == True and self.objects[item][1] == 2:
                   print(item)
                   return item
